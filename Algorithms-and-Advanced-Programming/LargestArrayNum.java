		...
		public class LargestArrayNum {
			...
			public static void main(String args[]) {
				...
				//declaring variables and input
				   int []myArray = {2,5,7,3,4,9,22,11,15,14};
				...
				//create a instance this allowed to get inform from other class
				   ...
				   //the larger of two numbers in the array
				   int largestNum = l1q.getLargestNum(myArray);
				   ...
				   System.out.println("The answer is =" + largestNum + " It took nanos seconds to process data " + elapsedTimeNano);
				  }
