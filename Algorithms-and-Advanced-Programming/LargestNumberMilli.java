...
*/
		...
		public class LargestNumberMilli {
			...
			public static void main(String args[]) {
				...
				//create a instance this allowed to get inform from other class
				   LabOneQuestions l1q = new LabOneQuestions();
					...
					//long startTime and endTime define milliseconds currentTimeMillis
				   ...
				   System.out.println("The answer is =" + largest + " and the amount of time in millisecond it took was =" +elapsedTime);
				  }
